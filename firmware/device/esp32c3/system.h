...
#define APB_SARADC_BASE 0x60040000
#define APB_SARADC_SAR1_PATT_TAB1_REG (APB_SARADC_BASE + 0x18)
#define APB_SARADC_CTRL_REG           (APB_SARADC_BASE + 0x00)
#define APB_SARADC_ONETIME_SAMPLE_REG (APB_SARADC_BASE + 0x0c)
